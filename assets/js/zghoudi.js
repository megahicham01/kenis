(function ($) {
  ...
  // Date Picker
  if ($(".zghoudi-datepicker").length) {
    $(".zghoudi-datepicker").each(function () {
      $(this).datepicker();
    });
  }
  ...
  //accordion
  if ($(".zghoudi-accordion").length) {
    var accordionGrp = $(".zghoudi-accordion");
        ...
        $(this)
          ...
          .on("click", function () {
            if ($(this).parent().hasClass("active") === false) {
              $(".zghoudi-accordion." + accordionName)
                .find(".accordion")
                .removeClass("active");
              $(".zghoudi-accordion." + accordionName)
                .find(".accordion")
  ...
  function thmOwlInit() {
    // owl slider
    let zghoudiowlCarousel = $(".zghoudi-owl__carousel");
    if (zghoudiowlCarousel.length) {
      zghoudiowlCarousel.each(function () {
        let elm = $(this);
    ...
    let zghoudiowlCarouselNav = $(".zghoudi-owl__carousel--custom-nav");
    if (zghoudiowlCarouselNav.length) {
      zghoudiowlCarouselNav.each(function () {
        let elm = $(this);
    ...
    let zghoudiowlCarouselWithCounter = $(
      ".zghoudi-owl__carousel--with-counter"
    );
    if (zghoudiowlCarouselWithCounter.length) {
      zghoudiowlCarouselWithCounter.each(function () {
        let elm = $(this);
        let options = elm.data("owl-options");
        ...
        elm
          .on("initialized.owl.carousel", function (event) {
            ...
            elm.append(
              '<div class="zghoudi-owl__carousel__counter"><span class="zghoudi-owl__carousel__counter__total"></span> <span class="zghoudi-owl__carousel__counter__current"></span></div>'
            );
            elm
              .find(".zghoudi-owl__carousel__counter__current")
              .text(
                addLeadingZero(carousel.relative(carousel.current()) + 1, 2)
              );
            elm
              .find(".zghoudi-owl__carousel__counter__total")
  ...
  //Strech Column
  function zghoudi_stretch() {
    var i = $(window).width();
    $(".row .zghoudi-stretch-element-inside-column").each(function () {
      var $this = $(this),
